...
require("../includes/permissao_documento.php");
	...
	$IMG_ROOT = "../../imagens/";	# Diretório onde as imagens serão transmitidas
	...
	if ($imagem_tipo != "1"){
		...
		if(file_exists( $IMG_ROOT . $categoria . "/" . $nome_da_imagem)) die($HTML_RETORNO1);
		...
		$nova_imagem_grande = $IMG_ROOT . $categoria . "/" . $nome_da_imagem;
		...
		$nova_imagem_thumb = $IMG_ROOT . $categoria . "/" . $THUMB_ROOT . "thumb_" . $nome_da_imagem;
		...
		###################################### GIF ##################################################
		if (move_uploaded_file($_FILES['image']['tmp_name'], $IMG_ROOT . $categoria . "/" . $nome_da_imagem)) {
			$nova_imagem_thumb = $IMG_ROOT . $categoria . "/" . $nome_da_imagem;
			$nova_imagem_grande = $IMG_ROOT . $categoria . "/" . $nome_da_imagem;
	...
	$query = "INSERT INTO imagens (nome, tamanho, caminho_img, caminho_thumb, categoria) VALUES ('";
	...
	$query = "SELECT cd FROM imagens WHERE nome='" . $nome_da_imagem . "' AND categoria='" . $categoria . "'";
