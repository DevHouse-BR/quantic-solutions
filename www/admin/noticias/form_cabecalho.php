...
require("../../includes/conectar_mysql.php");
	...
	if ($_POST["modo"] == "update"){
		...
		$query .= "parametro='" . $_POST["conteudo"] . "' where nome='cabecalho_noticias'";
			...
			<tr>
				<td align="center">
					...
					<form name="frm1" method="post" action="form_cabecalho.php">
						<tr> 
							<td colspan="3" style="border: 1px solid #FFFFFF; text-align: center;"><b>Cabeçalho da Página de Notícias</b></td>
						</tr>
						<tr> 
