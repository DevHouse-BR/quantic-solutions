...
require("../../includes/conectar_mysql.php");
	...
	if ($_POST["modo"] == "update"){
		...
		$query .= "parametro='" . $_POST["conteudo"] . "' where nome='cabecalho_form_parceria'";
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center">
					...
					<form name="frm1" method="post" action="form_cabecalho_formulario.php">
						<tr> 
							<td colspan="3" style="border: 1px solid #FFFFFF; text-align: center;"><b>Cabeçalho do Formulário de Parceria</b></td>
						</tr>
						<tr> 
						  <td width="11%" class="label">Conteúdo<br><br><br><br><br><br><br><br><br><br><input type="button" value="Editar Conteúdo" name="edita_conteudo" class="botao" onClick="javascript: editaconteudo();"></td>
