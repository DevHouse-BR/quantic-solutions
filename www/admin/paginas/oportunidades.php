...
require("../../includes/conectar_mysql.php");
	...
	if ($_POST["modo"] == "update"){
		...
		$query .= "parametro='" . $_POST["conteudo"] . "' where nome='oportunidades'";
...
<html>
	<head>
		<title>Oportunidades/Vagas</title>
		<style type="text/css">
			<!--
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center">
					...
					<form name="frm1" method="post" action="oportunidades.php">
						<tr> 
							<td colspan="3" style="border: 1px solid #FFFFFF; text-align: center;"><b>Conteúdo da Página de Oportunidades</b></td>
						</tr>
						<tr> 
