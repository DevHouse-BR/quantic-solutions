...
require("../../includes/conectar_mysql.php");
	...
	if ($_POST["modo"] == "update"){
		...
		$query .= "parametro='" . $_POST["conteudo"] . "' where nome='downloads'";
	...
	$query = "SELECT parametro FROM parametros WHERE nome='downloads'";
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center">
					...
					<form name="frm1" method="post" action="downloads.php">
						<tr> 
							<td colspan="3" style="border: 1px solid #FFFFFF; text-align: center;"><b>Conteúdo da Página de Downloads</b></td>
						</tr>
						<tr> 
