				...
				<td align="center">
					<table width="775" border="0" cellspacing="0" cellpadding="0" class="pagina">
						...
						<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="menuesquerdo">
									...
									<?php
										...
										while ($secao = mysql_fetch_array($result, MYSQL_ASSOC)){
											if ($i == 0) {
												echo("<tr><td height=\"23\" valign=\"bottom\"><div style=\"cursor: hand;\" onClick=\"self.location='clientes.php?secao=" . $secao["cd"] ."';\">" . $secao["secao"] . "</div></td></tr>");
												$i++;
											}
											else {
												echo("<tr><td style=\"letter-spacing: 5px;\">..........</td></tr><tr><td height=\"23\" valign=\"bottom\"><div style=\"cursor: hand;\" onClick=\"self.location='clientes.php?secao=" . $secao["cd"] ."';\">" . $secao["secao"] . "</div></td></tr>");
											}
										} 
							...
							<td>
								<iframe width="100%" height="450" src="vercliente.php?cd=<?=$codigo?>" frameborder="0" name="viz"></iframe>
							</td>
