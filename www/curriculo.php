<?php
	...
	if ($secao == 1){
		$src = "oportunidades.php";
	}
	if ($secao == 2){
		$src = "formulario_curriculo.php";
	}
?>
<html>
	<head>
						...
						<tr>
          					<td valign="top" bgcolor="#E4824C">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="menuesquerdo">
									...
									<tr>
										<td height="23" valign="bottom" <?php if($secao == 1) echo("style=\"color: #4e4e4e\""); ?>><div style="cursor: hand;" onClick="javascript: location = 'curriculo.php?secao=1';">Oportunidades</div></td>
									</tr>
									<tr>
										<td style="letter-spacing: 5px;">..........</td>
									</tr>
									<tr>
										<td height="23" valign="bottom" <?php if($secao == 2) echo("style=\"color: #4e4e4e\""); ?>><div style="cursor: hand;" onClick="javascript: location = 'curriculo.php?secao=2';">Seu Curr&iacute;culo</div></td>
									</tr>
								</table>
							</td>
							<td>
